...
- 📊 Displays total donations received
- 👥 Shows total number of donors
- 📋 Lists recent donation details
...
```bash
git clone https://github.com/laxmisanjaybadiger899-git/donation-dashboard.git
...
2. Frontend is automatically deployed on Vercel
3. Backend API is hosted on Render
